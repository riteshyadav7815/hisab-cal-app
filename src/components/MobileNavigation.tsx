...
import { Menu, X, Home, Users, Plus, BarChart3, Settings, User, LogOut, ArrowLeftRight } from "lucide-react";
      ...
      <div className="bg-white/5 backdrop-blur-lg border-t border-white/10 p-3 sm:p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-white font-bold text-lg sm:text-xl">Hisab</span>
          </div>
